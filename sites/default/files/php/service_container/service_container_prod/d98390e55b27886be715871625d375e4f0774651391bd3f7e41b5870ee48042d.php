...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cache_context.url.host' => 'getCacheContext_Url_HostService',
    ...
    /**
     * Gets the 'cache.libraries' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\Core\Cache\CacheBackendInterface A Drupal\Core\Cache\CacheBackendInterface instance.
     */
    protected function getCache_LibrariesService()
    {
        $this->services['cache.libraries'] = $instance = $this->get('cache_factory')->get('library');

        $instance->_serviceId = 'cache.libraries';
    ...
    /**
     * Gets the 'cache_context.url.host' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\Core\Cache\HostCacheContext A Drupal\Core\Cache\HostCacheContext instance.
     */
    protected function getCacheContext_Url_HostService()
    {
        $this->services['cache_context.url.host'] = $instance = new \Drupal\Core\Cache\HostCacheContext($this->get('request_stack'));

        $instance->_serviceId = 'cache_context.url.host';
    ...
    {
        $this->services['comment.link_builder'] = $instance = new \Drupal\comment\CommentLinkBuilder($this->get('current_user'), $this->get('comment.manager'), $this->get('module_handler'), $this->get('string_translation'));
    ...
    {
        $this->services['comment.post_render_cache'] = $instance = new \Drupal\comment\CommentPostRenderCache($this->get('entity.manager'), $this->get('entity.form_builder'), $this->get('current_user'), $this->get('comment.manager'), $this->get('module_handler'), $this->get('renderer'));

        $instance->_serviceId = 'comment.post_render_cache';
    ...
    {
        $this->services['config_import_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\ConfigImportSubscriber();
    ...
    {
        $this->services['entity.definitions.installed'] = $instance = $this->get('keyvalue')->get('entity.definitions.installed');

        $instance->_serviceId = 'entity.definitions.installed';
    ...
    {
        $this->services['entity.query.config'] = $instance = new \Drupal\Core\Config\Entity\Query\QueryFactory($this->get('config.factory'));
    ...
    {
        $this->services['main_content_renderer.html'] = $instance = new \Drupal\Core\Render\MainContent\HtmlRenderer($this->get('title_resolver'), $this->get('plugin.manager.display_variant'), $this->get('event_dispatcher'), $this->get('plugin.manager.element_info'), $this->get('module_handler'), $this->get('renderer'), $this->get('render_cache'), $this->get('cache_contexts_manager'));
    ...
    {
        $this->services['menu.active_trail'] = $instance = new \Drupal\Core\Menu\MenuActiveTrail($this->get('plugin.manager.menu.link'), $this->get('current_route_match'));
    ...
    {
        $this->services['menu.link_tree'] = $instance = new \Drupal\Core\Menu\MenuLinkTree($this->get('menu.tree_storage'), $this->get('plugin.manager.menu.link'), $this->get('router.route_provider'), $this->get('menu.active_trail'), $this->get('controller_resolver'), $this->get('cache.menu'), $this->get('current_route_match'));
    ...
    {
        $this->services['module_handler'] = $instance = new \Drupal\Core\Extension\ModuleHandler($this->get('app.root'), array('block' => array('type' => 'module', 'pathname' => 'core/modules/block/block.info.yml', 'filename' => 'block.module'), 'block_content' => array('type' => 'module', 'pathname' => 'core/modules/block_content/block_content.info.yml', 'filename' => 'block_content.module'), 'breakpoint' => array('type' => 'module', 'pathname' => 'core/modules/breakpoint/breakpoint.info.yml', 'filename' => 'breakpoint.module'), 'ckeditor' => array('type' => 'module', 'pathname' => 'core/modules/ckeditor/ckeditor.info.yml', 'filename' => 'ckeditor.module'), 'color' => array('type' => 'module', 'pathname' => 'core/modules/color/color.info.yml', 'filename' => 'color.module'), 'colorbox' => array('type' => 'module', 'pathname' => 'modules/colorbox/colorbox.info.yml', 'filename' => 'colorbox.module'), 'comment' => array('type' => 'module', 'pathname' => 'core/modules/comment/comment.info.yml', 'filename' => 'comment.module'), 'config' => array('type' => 'module', 'pathname' => 'core/modules/config/config.info.yml', 'filename' => 'config.module'), 'contact' => array('type' => 'module', 'pathname' => 'core/modules/contact/contact.info.yml', 'filename' => 'contact.module'), 'contextual' => array('type' => 'module', 'pathname' => 'core/modules/contextual/contextual.info.yml', 'filename' => 'contextual.module'), 'datetime' => array('type' => 'module', 'pathname' => 'core/modules/datetime/datetime.info.yml', 'filename' => 'datetime.module'), 'dblog' => array('type' => 'module', 'pathname' => 'core/modules/dblog/dblog.info.yml', 'filename' => 'dblog.module'), 'editor' => array('type' => 'module', 'pathname' => 'core/modules/editor/editor.info.yml', 'filename' => 'editor.module'), 'entity_reference' => array('type' => 'module', 'pathname' => 'core/modules/entity_reference/entity_reference.info.yml', 'filename' => 'entity_reference.module'), 'field' => array('type' => 'module', 'pathname' => 'core/modules/field/field.info.yml', 'filename' => 'field.module'), 'field_ui' => array('type' => 'module', 'pathname' => 'core/modules/field_ui/field_ui.info.yml', 'filename' => 'field_ui.module'), 'file' => array('type' => 'module', 'pathname' => 'core/modules/file/file.info.yml', 'filename' => 'file.module'), 'filter' => array('type' => 'module', 'pathname' => 'core/modules/filter/filter.info.yml', 'filename' => 'filter.module'), 'geolocation' => array('type' => 'module', 'pathname' => 'modules/geolocation/geolocation.info.yml', 'filename' => 'geolocation.module'), 'help' => array('type' => 'module', 'pathname' => 'core/modules/help/help.info.yml', 'filename' => 'help.module'), 'history' => array('type' => 'module', 'pathname' => 'core/modules/history/history.info.yml', 'filename' => 'history.module'), 'image' => array('type' => 'module', 'pathname' => 'core/modules/image/image.info.yml', 'filename' => 'image.module'), 'libraries' => array('type' => 'module', 'pathname' => 'modules/libraries/libraries.info.yml', 'filename' => 'libraries.module'), 'link' => array('type' => 'module', 'pathname' => 'core/modules/link/link.info.yml', 'filename' => 'link.module'), 'menu_ui' => array('type' => 'module', 'pathname' => 'core/modules/menu_ui/menu_ui.info.yml', 'filename' => 'menu_ui.module'), 'node' => array('type' => 'module', 'pathname' => 'core/modules/node/node.info.yml', 'filename' => 'node.module'), 'options' => array('type' => 'module', 'pathname' => 'core/modules/options/options.info.yml', 'filename' => 'options.module'), 'page_cache' => array('type' => 'module', 'pathname' => 'core/modules/page_cache/page_cache.info.yml', 'filename' => 'page_cache.module'), 'path' => array('type' => 'module', 'pathname' => 'core/modules/path/path.info.yml', 'filename' => 'path.module'), 'quickedit' => array('type' => 'module', 'pathname' => 'core/modules/quickedit/quickedit.info.yml', 'filename' => 'quickedit.module'), 'rdf' => array('type' => 'module', 'pathname' => 'core/modules/rdf/rdf.info.yml', 'filename' => 'rdf.module'), 'search' => array('type' => 'module', 'pathname' => 'core/modules/search/search.info.yml', 'filename' => 'search.module'), 'shortcut' => array('type' => 'module', 'pathname' => 'core/modules/shortcut/shortcut.info.yml', 'filename' => 'shortcut.module'), 'system' => array('type' => 'module', 'pathname' => 'core/modules/system/system.info.yml', 'filename' => 'system.module'), 'taxonomy' => array('type' => 'module', 'pathname' => 'core/modules/taxonomy/taxonomy.info.yml', 'filename' => 'taxonomy.module'), 'text' => array('type' => 'module', 'pathname' => 'core/modules/text/text.info.yml', 'filename' => 'text.module'), 'toolbar' => array('type' => 'module', 'pathname' => 'core/modules/toolbar/toolbar.info.yml', 'filename' => 'toolbar.module'), 'tour' => array('type' => 'module', 'pathname' => 'core/modules/tour/tour.info.yml', 'filename' => 'tour.module'), 'update' => array('type' => 'module', 'pathname' => 'core/modules/update/update.info.yml', 'filename' => 'update.module'), 'user' => array('type' => 'module', 'pathname' => 'core/modules/user/user.info.yml', 'filename' => 'user.module'), 'views_ui' => array('type' => 'module', 'pathname' => 'core/modules/views_ui/views_ui.info.yml', 'filename' => 'views_ui.module'), 'weight' => array('type' => 'module', 'pathname' => 'modules/weight/weight.info.yml', 'filename' => 'weight.module'), 'menu_link_content' => array('type' => 'module', 'pathname' => 'core/modules/menu_link_content/menu_link_content.info.yml', 'filename' => 'menu_link_content.module'), 'views' => array('type' => 'module', 'pathname' => 'core/modules/views/views.info.yml', 'filename' => 'views.module'), 'standard' => array('type' => 'profile', 'pathname' => 'core/profiles/standard/standard.info.yml', 'filename' => 'standard.profile')), $this->get('cache.bootstrap'));
    ...
    {
        $this->services['theme_handler'] = $instance = new \Drupal\Core\Extension\ThemeHandler($this->get('app.root'), $this->get('config.factory'), $this->get('module_handler'), $this->get('state'), $this->get('info_parser'), $this->get('logger.channel.default'), $this->get('asset.css.collection_optimizer'), $this->get('config.installer'), $this->get('config.manager'), $this->get('router.builder'));
    ...
    {
        $this->services['view_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\ViewSubscriber($this->get('title_resolver'));

        $instance->_serviceId = 'view_subscriber';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'colorbox' => array(
                    'type' => 'module',
                    'pathname' => 'modules/colorbox/colorbox.info.yml',
                ...
                'geolocation' => array(
                    'type' => 'module',
                    'pathname' => 'modules/geolocation/geolocation.info.yml',
                    'filename' => 'geolocation.module',
                ),
                'help' => array(
                    'type' => 'module',
                ...
                'libraries' => array(
                    'type' => 'module',
                    'pathname' => 'modules/libraries/libraries.info.yml',
                    'filename' => 'libraries.module',
                ),
                'link' => array(
                    'type' => 'module',
                ...
                'weight' => array(
                    'type' => 'module',
                    'pathname' => 'modules/weight/weight.info.yml',
                    'filename' => 'weight.module',
                ),
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\colorbox' => 'modules/colorbox/src',
                ...
                'Drupal\\weight' => 'modules/weight/src',
